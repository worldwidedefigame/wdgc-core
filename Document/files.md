...
* wdgc.conf: contains configuration settings for wdgcd or wdgc-qt
* wdgcd.pid: stores the process id of wdgcd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by wdgcd or wdgc-qt
