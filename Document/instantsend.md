...
This mechanism has been integrated into Bitcore-Node-Wdgc which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wdgcpay/insight-api-wdgc#web-socket-api](https://github.com/wdgcpay/insight-api-wdgc#web-socket-api)
* API: [https://github.com/wdgcpay/insight-api-wdgc#instantsend-transactions](https://github.com/wdgcpay/insight-api-wdgc#instantsend-transactions)
